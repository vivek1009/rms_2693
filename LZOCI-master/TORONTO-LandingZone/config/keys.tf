...
module "lz_keys_policies" {
    ...
    policies  = {
        "${local.oss_key_name}-policy" = {
            ...
            description = "Politique pour la Landing Zone pour permettre l'accès à la clé OCI ${module.lz_keys.keys[local.oss_key_name].display_name} dans le service Vault."
            statements = [
